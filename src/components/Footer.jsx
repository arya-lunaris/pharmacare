    ...
    <footer className="bg-[#E3DFEC] mt-30 py-12">
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between space-y-12 md:space-y-0 md:space-x-12">
        ...
        <div className="flex flex-col items-center md:items-center space-y-2">
          <h2 className="text-2xl font-bold text-[#5C427D] mb-7">Members of</h2>
          <div className="flex flex-col items-center -space-y-4">
            <img src="/images/registered.png" alt="Registered" className="h-20 w-20 object-contain mb-2" />
            <img src="/images/npa.png" alt="NPA" className="h-35 w-35 object-contain" />
            <img src="/images/gphc.png" alt="GPHC" className="h-35 w-35 object-contain" />
          </div>
        </div>

        {/* In partnership */}
        <div className="flex flex-col items-center md:items-center space-y-2">
          <h2 className="text-2xl font-bold text-[#5C427D]">In partnership with</h2>
          <div className="flex flex-col items-center -space-y-4">
            <img src="/images/camascope.jpg" alt="Camascope" className="h-40 w-40 object-contain" />
            <img src="/images/caremeds.jpg" alt="Caremeds" className="h-30 w-30 object-contain" />
            <img src="/images/atlas.png" alt="Atlas" className="h-35 w-35 object-contain" />
          </div>
        </div>
        ...
        <div className="flex flex-col items-center md:items-center space-y-4">
          ...
          <div className="flex flex-col items-center space-y-6">
            <div className="flex items-center space-x-3 text-lg">
              <img src="/images/address.png" alt="Address icon" className="h-8 w-8" />
            ...
            <div className="flex items-center space-x-3 text-lg">
              <img src="/images/email.png" alt="Email icon" className="h-8 w-8" />
            ...
            <div className="flex items-center space-x-3 text-lg">
              <img src="/images/phone.png" alt="Phone icon" className="h-8 w-8" />
